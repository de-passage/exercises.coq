...
Proof with eauto.
    induction T; intros; destruct H1 as [Ht [Hh B]].
    split... split... apply (step_preserves_halting _ _ H0)...
    split... split. apply (step_preserves_halting _ _ H0)...
    intros. eapply IHT2... eapply T_App... apply R_typable_empty in H1...
    inversion B.
Qed.
...
Proof with eauto.
  induction t; intros...
  - unfold not in H. destruct (eqb_stringP x s). subst.
    assert (appears_free_in s (var s))... contradiction.
    simpl. apply false_eqb_string in n. rewrite n...
  - simpl. rewrite IHt1... rewrite IHt2...
  - simpl. destruct (eqb_stringP x s); subst... rewrite IHt...
  - simpl. rewrite IHt1... rewrite IHt2...
  - simpl. rewrite IHt...
  - simpl. rewrite IHt...
  - simpl. rewrite IHt1, IHt2, IHt3...
Qed.
...
Proof with eauto.
 induction t; intros; simpl...
  ...
  - rewrite IHt1, IHt2...
  - destruct (eqb_stringP x s), (eqb_stringP x1 s)...
    rewrite IHt...
  - rewrite IHt1, IHt2...
  - rewrite IHt...
  - rewrite IHt...
