...
Proof with eauto.
  ...
  eapply S_Trans. eapply S_RcdPerm... discriminate.
  auto.
Qed.
...
Proof with eauto.
  eapply S_Arrow... apply subtyping_example_1.
Qed.
(** [] *)
...
Proof with eauto.
  eapply S_Trans. apply S_RcdDepth. apply S_Refl... eapply S_RcdPerm...
  discriminate. auto. auto. eapply S_Trans. eapply S_RcdPerm... discriminate.
  eapply S_RcdDepth... eapply S_RcdPerm... discriminate.
Qed.
(** [] *)
...
Proof with eauto.
  ...
  - destruct IHHs2 with V1 V2 as [U1 [U2 [HA [HU1 HU2]]]]...
    apply IHHs1 in HA as [U3 [U4 [HA [HU3 HU4]]]]. subst.
    exists U3, U4...
...
Proof.
  apply T_RCons. apply T_Abs. apply wfBase. apply T_Var. reflexivity.
  apply wfBase. apply T_RCons. apply T_Abs. apply wfBase. apply T_Var.
  reflexivity. apply wfBase. apply T_RNil. apply RTnil. apply rtnil.
...
(* empty |- (\x:{k:A->A,j:B->B}. x.j)
         ...
         : B->B *)
Proof with eauto.
  eapply T_App. apply T_Abs... apply wfRCons...
  unfold trcd_kj, TRcd_j. eapply T_Sub. eapply T_RCons...
  eapply S_Trans. eapply S_RcdPerm... discriminate. eapply S_RcdDepth...
Qed.
(** [] *)
...
(* empty |- (\z:(C->C)->{j:B->B}. (z (\x:C.x)).j)
           ...
           : B->B *)
Proof with eauto.
  eapply T_App. apply T_Abs. apply wfArrow... apply wfRCons...
  unfold TRcd_j. eapply T_Proj. eapply T_App... apply T_Var...
  reflexivity. apply T_Abs... unfold trcd_kj, TRcd_j.
  eapply T_Sub. eapply T_RCons... eapply S_Trans. apply S_RcdPerm...
  discriminate. apply S_RcdDepth...
Qed.
(** [] *)
