...
(* ===> byntree_ind 
      : forall P : byntree -> Prop
          ...
          (forall (y: yesno) t1: byntree), 
            P t1 -> forall t2: byntree, P t2 -> P (nbranch y t1 t2)) -?
          (forall b: byntree, P n)
*)
...
Proof.
  induction n.
  + reflexivity.
  + intros m o. unfold P_plus_assoc. simpl. apply f_equal. apply IHn.
Qed.
...
Proof.
 induction n.
 + unfold P_plus_comm. apply plus_n_O.
 + unfold P_plus_comm. simpl. intros m. rewrite <- plus_n_Sm.
